    ...
    <header className="bg-[#fafafa] fixed top-0 left-0 w-full z-50">
      <div className="grid grid-cols-3 items-center px-4 py-3 w-full">
        ...
        <nav className="justify-self-center hidden md:flex gap-6 text-sm text-[#252524] font-medium">
          <Link href="#tentang" className="hover:text-green-700 transition">
            Tentang
          </Link>
          <Link href="#agenda" className="hover:text-green-700 transition">
            Agenda
          </Link>
          <Link href="#peta" className="hover:text-green-700 transition">
            Peta
          </Link>
          <Link href="#cctv" className="hover:text-green-700 transition">
            CCTV
          </Link>
        </nav>
